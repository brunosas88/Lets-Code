...
export function createErrorView () {
    ...
    const div = document.createElement('div')
    div.setAttribute('class', 'errorView')
    const pFirst = document.createElement('p')
    const pSecond = document.createElement('p')
    const pLast = document.createElement('p')
    const pStatus = document.createElement('p')

    pFirst.setAttribute('class', 'pErrorView')
    pSecond.setAttribute('class', 'pErrorView')
    pLast.setAttribute('class', 'pErrorView')
    pStatus.setAttribute('id', 'statusErrorView')
    pFirst.innerText =  'OOOPS!'
    pSecond.innerText = 'ALGO DEU ERRADO NA SUA BUSCA.'
    pStatus.innerText = 'status 500'
    pLast.innerText = 'POR FAVOR, TENTE NOVAMENTE'
